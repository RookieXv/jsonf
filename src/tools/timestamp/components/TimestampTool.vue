...
const LOCALES = {
  'zh-CN': {
    ...
    codeTitle: '获取当前时间戳', codeSubtitle: '选择语言，复制可直接使用的代码', codeTag: '代码模块', copyCode: '复制代码', localOnly: '全部在浏览器本地计算', precision: '可识别 10 / 13 / 16 / 19 位时间戳',
  ...
  'zh-TW': {
    ...
    codeTitle: '取得目前時間戳', codeSubtitle: '選擇語言，複製可直接使用的程式碼', codeTag: '程式碼模組', copyCode: '複製程式碼', localOnly: '全部在瀏覽器本地計算', precision: '可識別 10 / 13 / 16 / 19 位時間戳',
  ...
  en: {
    ...
    codeTitle: 'Get the current timestamp', codeSubtitle: 'Choose a language and copy ready-to-use code', codeTag: 'Code', copyCode: 'Copy code', localOnly: 'Computed locally in your browser', precision: 'Detects 10 / 13 / 16 / 19-digit timestamps',
